    ...
    <footer className="bg-earth-900 text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <span className="block text-xl font-bold text-white font-serif">Castor Finishing</span>
                <span className="block text-xs text-gray-400">Professional Contractor</span>
                <span className="block text-[0.6rem] tracking-[0.4em] text-gold-500 uppercase">8 Tanager Way, Winkler, MB R6M 0E7</span>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed font-light">
              Professional finishing and contracting services for your renovation needs.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300 text-sm tracking-wide">
              ...
              <li><Link to="/about" className="hover:text-gold-500 transition-colors flex items-center"><span className="w-1 h-1 bg-gold-500 rounded-full mr-2"></span>About Us</Link></li>
        ...
        <div className="border-t border-white/5 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-xs">
          <p>&copy; {new Date().getFullYear()} Castor Finishing. All rights reserved.</p>
